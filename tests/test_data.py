...
def xg_row(match_id, match_date):
    return {
        "match_id": match_id,
...
def test_api_football_xg_replaces_understat_from_its_first_match_date():
    ...
    understat = [
        xg_row("eng-premier-league:2022-2023:a:b", "2022-08-06"),
        xg_row("eng-premier-league:2022-2023:c:d", "2023-01-20"),
        xg_row("eng-premier-league:2026-2027:e:f", "2026-08-20"),
    ]
    api = [
        xg_row("eng-premier-league:2022-2023:g:h", "2023-01-18"),
        xg_row("eng-championship:2023-2024:i:j", "2023-08-04"),
    ]
